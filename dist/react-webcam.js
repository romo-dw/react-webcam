...
var Webcam = function (_Component) {
  ...
  _createClass(Webcam, [{
    ...
    value: function componentDidMount() {
      ...
      this.video = (0, _reactDom.findDOMNode)(this);
    ...
    value: function getCanvas() {
      ...
      if (!this.ctx) {
        ...
        _canvas2.width = this.video.clientWidth;
        _canvas2.height = this.video.clientWidth / this.webcamAspectRatio;
